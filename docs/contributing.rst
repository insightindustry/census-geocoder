...
.. note::
  ...
  As a general rule of thumb, the **US Census Geocoder** applies :pep:`PEP 8 <8>` styling,
...
The **Census Geocoder** is meant to be a "beautiful" and "usable" library. That means
...
the **US Census Geocoder** we rely on several tools:
...
#. Fork the `Git repository <https://github.com/insightindustry/census-geocoder>`_.
...
Check for open `issues <https://github.com/insightindustry/census-geocoder/issues>`_
...
.. seealso::
  ...
  For more information about the **Census Geocoder** testing approach please
  see: :doc:`Testing the Census Geocoder <testing>`
