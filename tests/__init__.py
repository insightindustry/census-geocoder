...
.. note::
  ...
  Unit tests for the **Census Geocoder** are written using `pytest`_ and
...
the **Census Geocoder**, we decided to focus on practicality. That means:
...
The **Census Geocoder** does not use any custom command-line options in its
test suite.
...
.. note::
  ...
  Because of the simplicity of the **Census Geocoder**, the test suite does
...
.. note::
  ...
  The **Census Geocoder** test suite does support incremental testing,
